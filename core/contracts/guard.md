...
```guard:exceptions
core/protocols/deck.md:180 — forbids hand-editing generated output; the opposite of a sanction
...
core/protocols/promote.md:982 — about mockup colour values, unrelated to workflow artefacts
```
