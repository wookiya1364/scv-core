...
```guard:exceptions
core/protocols/deck.md:143 — forbids hand-editing generated output; the opposite of a sanction
...
core/protocols/promote.md:108 — forbids hand-editing .env; routes the write to a script instead
core/protocols/promote.md:847 — about mockup colour values, unrelated to workflow artefacts
```
